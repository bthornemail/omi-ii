export function bind(mneumonic: Uint8Array,metric: Uint16Array) {
//    const centroid = new ArrayBuffer(60 * 16 * 4);
    const centroid = new Float64ArrayBuffer(mneumonic.BYTE_COUNT);
    const ball = new Uint8Array(centroid);
    const sphere = new SharedArrayBuffer(centroid,ball.);
