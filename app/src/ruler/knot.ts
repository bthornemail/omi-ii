...
type CONFIG = [DELTA, METRIC][];
function knot(knot:KNOT, config:CONFIG): [KNOT, CONFIG]{
return (schalifi: CONFIG,betti: CONFIG)=>[fold:(schalifi,betti,[KNOT,CONFIG])=>KNOT,
unfold: (schalifi,bettie,[KNOT,CONFIG])=>CONFIG}]
}
