...
<div>
<button id="root-button">click</button>
<ul id="root-list"></ul>
...
function init() {
    const [div, canvas, list, table, form, btn] = [
        ...
        document.querySelector<HTMLButtonElement>('#root-button')!
    ]
    //    linkedList(list);
    //  tree(table);
    div.innerText = "hello";
...
function handleOrientation(event) {
    ...
    const div = document.querySelector<HTMLDivElement>('#root-element')!;
    div.innerText += `${absolute}, ${alpha}, ${beta}, ${gamma}`;
...
function handleMotion(event) {
    ...
    const div = document.querySelector<HTMLDivElement>('#root-element')!;
    div.innerText += `${acceleration}, ${accelerationIncludingGravity}, ${rotationRate}, ${interval}`;
}
